...
type Config struct {
	...
	UpstreamRequestTimeout types.Duration `json:"upstreamRequestTimeout"`
	ReadTimeout            types.Duration `json:"readTimeout"`
	WriteTimeout           types.Duration `json:"writeTimeout"`
	IdleTimeout            types.Duration `json:"idleTimeout"`
	ErrFor                 types.Duration `json:"errFor"`
